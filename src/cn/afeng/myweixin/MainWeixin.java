...
public class MainWeixin extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //将要分页显示的View装入数组中
        ...
        View view2 = mLi.inflate(R.layout.my_activity, null);
	...
	public void btnmainright(View v) {  
		Intent intent = new Intent (MainWeixin.this,Searh_history.class);			
		startActivity(intent);	
		//Toast.makeText(getApplicationContext(), "点击了功能按钮", Toast.LENGTH_LONG).show();
      }  	
	public void startchat(View v) {      //小黑  对话界面
		Intent intent = new Intent (MainWeixin.this,Details.class);			
		startActivity(intent);	
		//Toast.makeText(getApplicationContext(), "登录成功", Toast.LENGTH_LONG).show();
      }  
	public void myattention(View v) {      //小黑  对话界面
		Intent intent = new Intent (MainWeixin.this,Attention.class);			
		startActivity(intent);	
		//Toast.makeText(getApplicationContext(), "登录成功", Toast.LENGTH_LONG).show();
      }  
	public void myissue(View v) {      //小黑  对话界面
		Intent intent = new Intent (MainWeixin.this,Issue_activity.class);			
		startActivity(intent);	
		//Toast.makeText(getApplicationContext(), "登录成功", Toast.LENGTH_LONG).show();
      }  
	public void myissue0(View v) {      //小黑  对话界面
		Intent intent = new Intent (MainWeixin.this,Issue.class);			
		startActivity(intent);	
		//Toast.makeText(getApplicationContext(), "登录成功", Toast.LENGTH_LONG).show();
      }  
	public void mypartners(View v) {      //小黑  对话界面
		Intent intent = new Intent (MainWeixin.this,Parteners.class);			
		startActivity(intent);	
		//Toast.makeText(getApplicationContext(), "登录成功", Toast.LENGTH_LONG).show();
      }  
	...
	public void attention_special(View v) {                                   //特别关注
		Intent intent = new Intent (MainWeixin.this,Attention_special.class);			
		startActivity(intent);	
	}
